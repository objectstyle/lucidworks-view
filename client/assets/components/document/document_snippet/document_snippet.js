(function () {
  angular.module('lucidworksView.components.document_snippet', ['lucidworksView.services.config',
    'lucidworksView.utils.docs', 'lucidworksView.services.signals'
  ])
    .directive('documentSnippet', documentSnippet);


  function documentSnippet() {
    'ngInject';
    return {
      templateUrl: 'assets/components/document/document_snippet/document_snippet.html',
      scope: true,
