(function () {
  ...
  function HomeController($window, $filter, $state, $timeout, $rootScope, ConfigService, QueryService, URLService, PaginateService, Orwell, AuthService, _, $log, $scope, DocumentService, $sce) {
